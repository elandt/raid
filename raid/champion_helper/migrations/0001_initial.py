...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='affinity',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('strength__isnull', True), ('weakness__isnull', True)), models.Q(('strength__isnull', False), ('weakness__isnull', False), models.Q(_negated=True, strength__eq=django.db.models.expressions.F('weakness'))), _connector='OR'), name='strength_weakness_are_both_null_or_populated_and_diff'),
        ),
        migrations.AddConstraint(
            model_name='affinity',
